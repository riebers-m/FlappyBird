...
namespace systems {
    ScriptSystem::ScriptSystem(game::LoggerPtr logger, entt::registry &registry) : BaseSystem(registry),
        m_logger{logger}, m_script_engine() {
    }
    ...
    void ScriptSystem::setup() const {
        m_script_engine.setup();
    }
